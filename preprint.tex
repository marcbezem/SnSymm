...
\begin{remark} Experimental picture(s). Let $\alpha: m_S=m_N$ and $\beta: m_N=m_S$.
\begin{center}
  \begin{tikzcd}[column sep=6em]
    
      m_S^{-1} m_N \arrow[equal]{r}{\ap{m_S^{-1}\cdot\blank}(\alpha^{-1})}& 
      m_S^{-1} m_S \arrow[equal]{r}{c(m_S,m_N)}& 
      m_N^{-1} m_N \arrow[equal]{r}{\ap{(\blank\cdot m_N)\circ{}^{-1}}(\beta)} & 
      m_S^{-1} m_N \\
   
      m_S^{-1} m_N\arrow[equal]{rrr}{\refl{}}&&&
      m_S^{-1} m_N
  \end{tikzcd}
\end{center}
