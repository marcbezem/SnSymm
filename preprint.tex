...
Obviously, $\iota_{\base}=\id_{\Sc}$ and hence, since $\Sc$ is connected, 
every $\iota_x$ is an equivalence that is merely equal to $\id_{\Sc}$.
Therefore we may view $\iota_x\from \Sc=\Sc$ as a path.
