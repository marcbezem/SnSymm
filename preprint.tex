...
\begin{lemma}
  For any $n\geq 1$, there is a group ismorphism:
  \begin{displaymath}
    \xi_n: \fgr(\Sn n \ptdto \Sn n) \weq \hgr {n+1} (\Sn n) 
  \end{displaymath}
...
\begin{proof}
  ...
  \refl\base)$ to $\Sloop: \loopspace(\Sc)$ and from there, one can prove by
  ...
  $\loopspace n (\Sn n) \to \hgr n (\Sn) \weq \ZZ$. However, the distinguished
