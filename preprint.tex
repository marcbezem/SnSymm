...
using the fact that $\sigma_A(a_0) = \refl N$, one finds a path
...
\begin{align*}
  H(\inl a) &\defequi \alpha_0 \cdot \ap{\alpha}(\sigma_A(a))
              \cdot \miniast\alpha\beta : \beta(N) = x_0 \\
  H(\inr b) &\defequi \beta_0 \cdot \ap{\beta}(\sigma_B(b))^{-1}
              \cdot \miniast\beta\alpha : \alpha(N) = x_0
\end{align*}
...
\begin{figure}
  ...
  \begin{tikzcd}[column sep=large]
    ...
    \alpha(N)\ar[r,"{\alpha_0}"]
    \ar[rd,tikzequal,dashed] &
    x_0\ar[d,"{\alpha_0^{-1}}"] \\
    & & &
    \alpha(N)\ar[d,"{\ap{\alpha}(\sigma_A\,a)^{-1}}"] \\
    & & &
    \alpha(N)\ar[d,"{\miniast\beta\alpha}"] \\
    \beta(N)\ar[ddd,"{\miniast\alpha\beta}"']
    \ar[rrrd,tikzequal,dashed] & & &
    \beta(N)\ar[d,"{\ap{\beta}(\sigma_B\,b)}"] \\
    & & &
    \beta(N)\ar[d,"{\miniast\alpha\beta}"] \\
    & & &
    \alpha(N)\ar[d,"{\ap{\alpha}(\sigma_A\,a)}"] \\
    \alpha(N)\ar[ddd,"{\ap{\alpha}(\sigma_A\,a)}"']
...
%\ar[ddd,"{\refl{\beta(N)}}"']\ar[r,"{\ap{\beta}(\sigma_B\,b)}"] &[10pt]
%\ar[r,"{\miniast\alpha\beta}"] &[-15pt]
%\ar[r,"{\ap{\alpha}(\sigma_A\,a)}"] &[10pt]
%\ar[rrr,"{\refl{\alpha(N)}}"] &[-15pt]
%
%
