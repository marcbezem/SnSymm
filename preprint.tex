...
%  For higher-dimensional spheres, there are again two connected
%  components, corresponding to maps of degree plus or minus one, but
%  the components are no longer spheres, as their fundamental groups have order two.
...
Examples of results are the type-theoretic Seifert-van Kampen theorem~\cite{houfavonia_et_al:LIPIcs:2016:6562}, the Blakers-Massey connectivity theorem~\cite{favonia_blakers}, and the construction of the Hopf fibration~\cite{HoTT}.
