...
\begin{remark} Experimental picture. Let $\alpha: m_S=m_N$ and $\beta: m_N=m_S$.
\begin{center}
  \begin{tikzcd}[column sep=6em]
    
      {\color{blue}m_S^{-1}}\cdot m_S \arrow[equal]{rrr}{c(m_S,m_N)}
                   \arrow[swap, equal]{dd}{\ap{{\color{blue}m_S^{-1}}\cdot\blank}(\alpha^{-1})}&&& 
      m_N^{-1}\cdot {\color{darkgreen}m_N} \arrow[equal]{dd}{\ap{(\blank\cdot {\color{darkgreen}m_N})\circ{}^{-1}}(\beta)} \\\\
      {\color{blue}m_S^{-1}}\cdot m_N \arrow[equal]{rrr}{\refl{}}&&&
