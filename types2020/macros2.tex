...
\newcommand{\inl}[1]{\mathop{\mathit{inl}_{#1}}}
...
\newcommand{\trp}[2][]{\mathop{\mathit{trp}^{#1}_{#2}}}
...
\newcommand{\defeq}{\mathrel{\raisebox{-.05ex}{$:$}\mkern-8mu\equiv}}
...
\newcommand{\Trunc}[1]{\left\lVert{#1}\right\rVert}
...
\newcommand{\Sn}[1]{{\mathbb S^{#1}}}%the circle
\newcommand{\Sc}{{\Sn 1}}%the circle
\newcommand{\Sp}{{\Sn 2}}%the circle
\newcommand{\mrd}{{\operatorname{\mathrm{merid}}}}%
%\newcommand{\sbt}{\begin{picture}(-1,1)(-1,-3)\circle*{2}\end{picture}}
\newcommand{\sbt}{\tikz[anchor=base,baseline]{\node[outer sep=0pt,inner sep=.3ex] (0,.7ex) {$\bullet$};}}
