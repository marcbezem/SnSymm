...
The propositional truncation $\Trunc{A}$ of an arbitrary type $A$ (\cite[Ch.]{HoTT});
The set truncation $\Trunc{A}_0$ of an arbitrary type $A$ (\cite[Ch.]{HoTT});
The circle $\Sc$ (\cite[Ch.]{HoTT});
The suspension $\susp A$ of an arbitrary type $A$ (\cite[Ch.]{HoTT}).
